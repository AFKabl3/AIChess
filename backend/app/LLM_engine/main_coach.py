...
class MainCoach(ChatBox):
    ...
    def ask_move_suggestion(self, suggestion):
        ...
        Provide a feedback using the suggested move. Try to limit the response to 70 words removing all the reference to Stockfish. Coach the user by providing explanation to the suggestion."""))
    ...
    def ask_chess_question(self, fen, question, evaluation):
        ...
        Provide a valid answer for this question in a chess context. Try to limit the response to 70 words."""))
