...
function formatUciMove(move) {
  ...
  // Handle pawn promotion (when the flag contains 'promotion')
  if (move.flags.includes("p")) {
    uciMove += move.piece.toLowerCase();
  }

  return uciMove;
}

export const ChessboardPage = ({ onPlayerMove }) => {
  ...
  function onDrop(source, target) {
    ...
    onPlayerMove(formatUciMove(move), currBoard);
